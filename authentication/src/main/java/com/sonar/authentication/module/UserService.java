...
import com.sonar.authentication.module.magiclink.Client;
...
public class UserService {
    ...
    public String makeClientLogin(Client client) {
        if (Objects.nonNull(userRepository.findByEmail(client.getEmail()))) {
            //we have user signed
            return "User present, redirect to user dashboard";
        }
        ...
        return "New user created, redirect to user dashboard";
    }
}
